...
public class LineChartDemo {
	...
	public static CategoryDataset createDataset(List<interview> list) {
		...
		for (int i = 0; i < list.size(); i++) {
			localDefaultCategoryDataset.addValue(list.get(i).getJieshao(),  "自我介绍", "no"+(i+1));
			localDefaultCategoryDataset.addValue(list.get(i).getProblem(), "人事问题", "no"+(i+1));
	...
	public static JFreeChart createDemoPanel(List<interview> list) {
		...
		JFreeChart localJFreeChart = createChart("模拟面试", "次数", "分数", database);
